...
const SearchBar: FC = () => {
  ...
  // useMemo ile her render sırasında tekrar hesaplanmasının önüne geçtik ve performans arttı
  // string[] olan makes'i react-select'e uygun formata getirdik.
  ...
  return (
    <form
      ...
      className="w-full searchbar gap-3 flex items-center justify-center"
    >
      <div className="searchbar-item items-end">
        <div className="w-full flex flex-col">
          ...
          <ReactSelect
            ...
            // varsayılan değeri url'den alıyoruz
            defaultValue={{
              label: params.get("make") || "BMW",
              value: params.get("make") || "BMW",
            }}
            // '!' operatörü ile e'nin null olmayacağını ts'e söyledik
